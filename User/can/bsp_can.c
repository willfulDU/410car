...
static void CAN_Mode_Config(void)
{
	...
	CAN_InitStructure.CAN_Mode = CAN_Mode_Normal;  //正常工作模式，这里配置回环模式等
 ...
 * 调用  ：外部调用
 */	 
void CAN_SetMsg(CanTxMsg *TxMessage,uint16_t value1,uint16_t value2)
{	  
    //uint8_t ubCounter = 0;
	...
	TxMessage->Data[0]=value1%256;
	TxMessage->Data[1]=value1/256;
	TxMessage->Data[2]=0;
	TxMessage->Data[3]=0;
	TxMessage->Data[4]=0;
	TxMessage->Data[5]=0;
	TxMessage->Data[6]=value2%256;
	TxMessage->Data[7]=value2/256;
}
